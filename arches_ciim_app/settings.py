"""
Django settings for arches_ciim_app project.
"""
...
# DATATYPE_LOCATIONS.append('dev_project_arches7_5.datatypes')
# FUNCTION_LOCATIONS.append('dev_project_arches7_5.functions')
# ETL_MODULE_LOCATIONS.append('dev_project_arches7_5.etl_modules')
# SEARCH_COMPONENT_LOCATIONS.append('dev_project_arches7_5.search_components')
...
SECRET_KEY = 'f%rs+j@b#lzsyn)%8tz0pmt^gz+)^lv67i8e^l#w^yfd^y=du5'
...
ELASTICSEARCH_CONNECTION_OPTIONS = {"request_timeout": 30, "verify_certs": False, "basic_auth": ("elastic", "ELASTIC_SEARCH_PASSWORD")}
...
ELASTICSEARCH_PREFIX = 'arches_ciim_app'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_ciim_app.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_ciim_app",
    # "dev_project_arches7_5",
)

ARCHES_APPLICATIONS = ("arches_ciim_app",)
...
WSGI_APPLICATION = 'arches_ciim_app.wsgi.application'
...
SESSION_COOKIE_NAME = 'arches_ciim_app'
